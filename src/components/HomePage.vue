        ...
        <div class="main-content">
            <div class="header-content sub-main-content">
                <div class="emp-detail-text">
                    Address Details <div class="emp-count">0</div>
                </div>
                <router-link to="/adddetails" class="add-button">
            ...
            <div class="table-main">
                <table class="table" id="display">
                    ...
                    <tr v-for="detail in details" :key="detail.id">
                        ...
                        <td>{{ detail.email }}</td>
                        <td>
                            <img @click="update(detail.id)" src="..\assets\icons\create-black-18dp.svg" alt="edit" width="30" height="30" />
                            <img @click="remove(detail.id)" src="..\assets\icons\delete-black-18dp.svg" alt="delete" width="30" height="30" />
                        </td>
                    </tr>
                </table>
            </div>
